...
import static com.finance.anubis.constants.Constants.ACTIVITY_INIT_EXEC_TIMES;

@EqualsAndHashCode(callSuper = true)
@Data
public class TaskActivity extends BaseModel {
    public final static Logger log = LoggerFactory.getLogger(TaskActivity.class);
    ...
    public TaskActivityResult getResult() {
        ...
        compareSourceData.forEach((key, sourceValue) -> {
            ...
            if (targetValue == null && sourceValue == null) {
                log.error("all data invalid,taskActivityId:{},key:{}", this.id, key);
